...
public abstract class DownloadObserver extends BaseDownloadObserver {
    ...
    public DownloadObserver(String fileName,String disk) {
        mDownloadManager=  new DownloadManager();
        mDownloadManager.setDestFileDir(true,disk);
        this.fileName = fileName;
        this.disk = disk;
    }
        ...
        Observable
                ...
                .subscribe(new Consumer<ResponseBody>() {
                    ...
                    public void accept(@NonNull ResponseBody responseBody) throws Exception {
                        try {
                            mDownloadManager .saveFile(responseBody, fileName, new ProgressListener() {
                                @Override
