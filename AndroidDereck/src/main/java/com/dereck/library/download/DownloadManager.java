...
public class DownloadManager {
    ...
    private boolean isCustomStorage=false;//是否自定义存储
    private String  CustomDisk;//是否自定义存储
    String destFileDir ;
    /**
     * 保存文件地址
     */
    public void setDestFileDir(boolean isCustomStorage,String CustomDisk){
...
if (isCustomStorage){
    destFileDir=CustomDisk;
}else {
    destFileDir = RxHttpUtils.getContext().getExternalFilesDir(null) + File.separator;
}
