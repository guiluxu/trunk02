package com.dereck.library.refreshrecyclerview.pulltorefresh;
...
import com.dereck.library.refreshrecyclerview.base.refreshview.BaseLoadMoreView;
import com.dereck.library.refreshrecyclerview.base.refreshview.BasePullToRefreshView;
import com.dereck.library.refreshrecyclerview.defaultview.DefaultArrowRefreshHeaderView;
...
public class PullToRefreshRecyclerView extends RecyclerView {
    ...
    private void init(Context context) {
        ...
        loadMoreView = new com.dereck.library.refreshrecyclerview.defaultview.DefaultLoadMoreView(context);
    }
    ...
    public void onScrollStateChanged(int state) {
        ...
        if (state == RecyclerView.SCROLL_STATE_IDLE && mLoadingListener != null && !isLoadingData && isAllowLoadMore && !isNoMoreDate) {
            ...
            //是否满屏
            if (com.dereck.library.refreshrecyclerview.pulltorefresh.PullToRefreshRecyclerViewUtils.isFullPage(this, lastVisibleItemPosition)) {
    ...
    private boolean isOnTop() {
        if (headerRefreshView == null)
            return false;
        return headerRefreshView.getParent() != null;
    }
