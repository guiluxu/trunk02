package com.dereck.library.refreshrecyclerview.defaultview;
...
public class DefaultArrowRefreshHeaderView extends com.dereck.library.refreshrecyclerview.base.refreshview.BasePullToRefreshView implements com.dereck.library.refreshrecyclerview.base.refreshview.BasePullToRefreshView.OnStateChangeListener {
    ...
    public void onStateChange(int state) {
        ...
        switch (state) {
            ...
            case STATE_RELEASE_REFRESH:
                //时间更新
                lastRefreshTimeTv.setText(com.dereck.library.refreshrecyclerview.pulltorefresh.PullToRefreshRecyclerViewUtils.getTimeConvert(com.dereck.library.refreshrecyclerview.pulltorefresh.PullToRefreshRecyclerViewUtils.getLastRefreshTime(context)));
                arrowIv.clearAnimation();
            ...
            case STATE_REFRESHING:
                ...
                break;
            case STATE_DONE:
                com.dereck.library.refreshrecyclerview.pulltorefresh.PullToRefreshRecyclerViewUtils.saveLastRefreshTime(context, System.currentTimeMillis());
