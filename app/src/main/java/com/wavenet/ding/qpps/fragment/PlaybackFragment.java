...
public class PlaybackFragment extends DialogFragment {
    ...
    long seconds = 0;
String mSoundurl;
    public PlaybackFragment newInstance(String url,long time) {
    ...
    public void onCreate(Bundle savedInstanceState) {
      ...
      long  time = getArguments().getLong("time");
        mSoundurl = getArguments().getString("url");
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        ColorFilter filter = new LightingColorFilter
                (getResources().getColor(R.color.colorPrimaryDark), getResources().getColor(R.color.colorPrimaryDark));
        ...
        mFileNameTextView.setText("录音文件");
    ...
    private void startPlaying() {
        ...
        try {
            mMediaPlayer.setDataSource(mSoundurl);
