...
public class SecondFragment extends BaseMvpFragment<AdminFragmentRequestView, OneFragmentRequestPresenter> implements AdminFragmentRequestView {
...
//        mWebView.loadUrl(getActivity().getIntent().getStringExtra("url"));
        ...
        mWebView.loadUrl(     AppUtils.getH5F2(getActivity()));
    }
...
//    };
    ...
    public void mapTrajectorycallback(String S_RECODE_ID,String s_man_name,String time,String xclc){
        Intent iHistory = new Intent(getActivity(), MapTrackPlayActivity.class);
