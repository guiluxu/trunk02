package com.wavenet.ding.qpps.utils.album;//package com.wavenet.app.patrolsystem.utils.album;
//
...
//
//import www.wavenet.com.citywatermanager.R;
//import www.wavenet.com.citywatermanager.activity.TakePhotoActivity1;
//
///**
// * @author: zzp
// * @since: 2015-06-10
...
// */
//public class PickOrTakeImageActivity1 extends Activity implements View.OnClickListener, AdapterView.OnItemClickListener,
...
//        sizenum = getIntent().getIntExtra("size",9);
//        picNums=sizenum;
//        initView();
//        initData();
//    }
...
//                    rl_choose_directory.setAlpha(1 - Math.abs(value / CommonUtil.dip2px(PickOrTakeImageActivity1.this, 400)));
...
//                    listView.setLayoutParams(params);
//                    rl_choose_directory.setAlpha(1 - Math.abs(value / CommonUtil.dip2px(PickOrTakeImageActivity1.this, 400)));
//                    if (value <= -CommonUtil.dip2px(PickOrTakeImageActivity1.this, 300)) {
...
//        //计算每张图片应该显示的宽度
//        perWidth = (((WindowManager) (getSystemService(WINDOW_SERVICE))).getDefaultDisplay().getWidth() - CommonUtil.dip2px(this, 4))/3;
//
//        picNums = getIntent().getIntExtra(EXTRA_NUMS, sizenum);
//
//        if (picNums == 1){
...
//        //需要弹出dialog让用户手动赋予权限
//        else{
//            ActivityCompat.requestPermissions(PickOrTakeImageActivity1.this, new String[]{Manifest.permission.WRITE_EXTERNAL_STORAGE}, CODE_FOR_WRITE_PERMISSION);
//        }
//    }
//
//    /**
...
//                intent.setClass(PickOrTakeImageActivity1.this, PickBigImagesActivity.class);
...
//
//        WeakReference<PickOrTakeImageActivity1> activity = null;
//
//        public MyHandler(PickOrTakeImageActivity1 context){
//            activity = new WeakReference<PickOrTakeImageActivity1>(context);
//        }
//
//        @Override
...
//                view = new ImageView(PickOrTakeImageActivity1.this);
...
//        Intent intent=new Intent(PickOrTakeImageActivity1.this, TakePhotoActivity1.class);
...
//                        toggleImageDirectoryModelStateFromMapById(position);
//                        Toast.makeText(PickOrTakeImageActivity1.this, String.format(getString(R.string.choose_pic_num_out_of_index), picNums), Toast.LENGTH_SHORT).show();
//                        return;
//                    }
//                    picklist.add(getImageDirectoryModelUrlFromMapById(holder.position));
//                    holder.iv_pick_or_not.setImageResource(R.drawable.image_choose);
...
////            intent=new Intent(PickOrTakeImageActivity1.this, UpWaterActivity.class);
////        } else {
////            intent = new Intent(PickOrTakeImageActivity1.this, ModifyWaterActivity.class);
////        }
////        Intent intent=new Intent(PickOrTakeImageActivity.this, UpWaterActivity.class);
////        String mOutPath=picklist.get(0);
//
//        Intent intent=new Intent();
//        intent.putExtra("bitmap", picklist);
//        setResult(3,intent);
//        finish();
//    }
//
