...
public class WebViewHistoryXJActivity1 extends WebViewActivity implements View.OnClickListener {
...
//    执行：maintainObject.continueMaintain(S_RECODE_ID);//调用原生方法
    ...
    public void mapTrackcallback (String S_RECORD_ID,boolean isDateCur) {//H5调用的轨迹功能，H5传给的事件id
        ...
        Intent iHistory= new Intent(WebViewHistoryXJActivity1.this, MapTrackAllActivity.class);
...
//        }
    ...
    public void mapLocacallback (String lat ,String lon) {//H5调用的轨迹功能，H5传给的事件id
        ...
        Intent iHistory = new Intent(WebViewHistoryXJActivity1.this, MapLocaActivity.class);
...
//        startActivity(iHistory);
    ...
    public void xjDealmapcallback(String S_MANGE_ID) {//H5调用的处置功能，H5传给的记录id
        ...
        Intent iHistory = new Intent(WebViewHistoryXJActivity1.this, XJDealActivity.class);
    ...
    public  boolean xjIsStartdecallback(String S_RECORD_ID) {//H5调用的判断当前操作的记录是否是正在执行的记录
        if (isStartde){
            if (S_RECORD_ID.equals(AppAttribute.F.getXJID(WebViewHistoryXJActivity1.this))){
                return true;
            }else {
                return false;
            }
