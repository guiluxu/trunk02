...
package com.wavenet.ding.qpps.view.viewutils.scrollLayout;
...
public class ContentScrollView extends ScrollView {
    ...
    protected void onAttachedToWindow() {
        ...
        while (parent != null) {
            if (parent instanceof ScrollLayoutView) {
                ((ScrollLayoutView) parent).setAssociatedScrollView(this);
                break;
            }
    ...
    public boolean onTouchEvent(MotionEvent ev) {
        ViewParent parent = this.getParent();
        if (parent instanceof ScrollLayoutView) {
            if (((ScrollLayoutView) parent).getCurrentStatus() == ScrollLayoutView.Status.OPENED)
                return false;
        }
