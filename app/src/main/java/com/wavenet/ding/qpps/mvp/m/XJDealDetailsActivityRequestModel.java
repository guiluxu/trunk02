...
public class XJDealDetailsActivityRequestModel implements IMvpBaseView {

    public void RequestDealDetails(String S_MANGE_ID, CommonObserver<Object> callback) {
...
//        String urlstr = AppConfig.BeasUrl+"2081/odata/PSSSYH/default/T_PATROL_MANAGEMENT?$select=S_SJSB_ID,S_SJCZ_ID,S_MANGE_MAN,T_MANGE_TIME&$filter=S_MANGE_ID eq '" + S_MANGE_ID + "'";
        String urlstr = AppConfig.BeasUrl+"2056/api/Management/T_PATROL_MANAGEMENT_operation?S_MANGE_ID=" + S_MANGE_ID + "&PAGE=1&PAGESIZE=1";
        RxHttpUtils
