...
public class TianDiTuMethodsClass {
    ...
    private static final String URL_VECTOR_2000 = "http://{subDomain}.tianditu.gov.cn/DataServer?T=vec_c&x={col}&y={row}&l={level}";
    ...
    private static final String tk = "&tk=06e9bbf4183d7917b3e58e35203645d0";//key值要去官网申请
