...
public class AdminControllerCameraView extends LinearLayout implements View.OnClickListener, ActionSheet.OnActionSheetSelected, GoBackInteDef.GoBack {
    private static final String TAG = TakePhotoActivity.class.getName();
    Context mContext;
    AdminSubmitActivity mActivity;
    ...
    public AdminControllerCameraView(Context context) {
        super(context);
        initView(context);
    }

    public AdminControllerCameraView(Context context, AttributeSet attrs) {
        super(context, attrs);
        initView(context);
    }


    public AdminControllerCameraView(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void initView(Context context) {
        mContext = context;
        mActivity = (AdminSubmitActivity) mContext;
                ...
                mDialogSound.setSListener(new DialogSound.SListener() {
                    ...
                    public void sListener(String soundurl, long time) {
                        ...
                        if (mRlsound.getVisibility() == GONE) {
                            ...
                            MapUtil.getInstance(mContext).showIsReplaceFileDialog(mContext, AdminControllerCameraView.this, GoBackInteDef.setBack(GoBackInteDef.REPLACESOUND), "只能上传一个语音文件，是否要替换已有的语音?");
                        }
...
//                        Log.e(LOG_TAG, "exception", e);
            ...
            case R.id.iv_photo:
                ...
                ActionSheetSuper.showSheet(mContext, true, AdminControllerCameraView.this, null);
//                ActionSheet.showSheet(mContext, AdminControllerCameraView.this, null);
                break;
        }
...
//        }
    ...
    AdminControllerCameraView.ShowGalleryPhotoListen mShowGalleryPhotoListen;

    public void setShowGalleryPhotoListen(AdminControllerCameraView.ShowGalleryPhotoListen mShowGalleryPhotoListen) {
    ...
    private AdminControllerCameraView.ShowExitViewListener listener;

    public void setExitViewListener(AdminControllerCameraView.ShowExitViewListener listener) {
