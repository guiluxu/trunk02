package com.wavenet.ding.qpps.utils.cameralibrary.state;
...
import com.wavenet.ding.qpps.utils.cameralibrary.CameraInterface;
...
class PreviewState implements State {
    ...
    public void foucs(float x, float y, CameraInterface.FocusCallback callback) {
        LogUtils.i(TAG, "preview state foucs");
    ...
    public void cancle(SurfaceHolder holder, float screenProp) {
        LogUtils.i(TAG, "浏览状态下,没有 cancle 事件");
    }

    @Override
    public void confirm() {
        LogUtils.i(TAG, "浏览状态下,没有 confirm 事件");
    }
