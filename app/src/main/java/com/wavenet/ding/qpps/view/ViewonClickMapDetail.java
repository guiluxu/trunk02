...
public class ViewonClickMapDetail extends LinearLayout implements View.OnClickListener, AdapterView.OnItemClickListener {
    public FourFragmentListAdapter mTradapter;
    Context mContext;
    //    private LoadingWaitView mLoadingWaitView;
    RadioGroup mRgf;
    RadioButton mRbf1, mRbf2, mRbf3, mRbf4, mRbf5, mRbf6, mRbf7;
    ListView listview;
    ArrayList<AdapterBean> mBeanList = new ArrayList<AdapterBean>();
    ...
    public ViewonClickMapDetail(Context context) {
        super(context);
        initView(context);
    }

    public ViewonClickMapDetail(Context context, AttributeSet attrs) {
        super(context, attrs);
        initView(context);
    }

    public ViewonClickMapDetail(Context context, AttributeSet attrs, int defStyle) {
            ...
            public void onCheckedChanged(RadioGroup radioGroup, int radioButtonId) {
                ...
                switch (str) {
                    ...
                    case "合流井":
                        if (MapUtil.ui==0){
                            MainMapXJActivity.onClickgraphicsOverlayPoint.setVisible(true);
                            MainMapXJActivity.onClickgraphicsOverlayLine.setVisible(false);
                        }else if (MapUtil.ui==1){
                            MainMapYHActivity mActivity= (MainMapYHActivity) mContext;
                            mActivity.mAAtt.initB().onClickgraphicsOverlayPoint.setVisible(true);
                            mActivity.mAAtt.initB().onClickgraphicsOverlayLine.setVisible(false);
                        }
                    ...
                    case "其他管":
                        if (MapUtil.ui==0){
                            MainMapXJActivity.onClickgraphicsOverlayPoint.setVisible(false);
                            MainMapXJActivity.onClickgraphicsOverlayLine.setVisible(true);
                        }else if (MapUtil.ui==1){
                            MainMapYHActivity mActivity= (MainMapYHActivity) mContext;
                            mActivity.mAAtt.initB().onClickgraphicsOverlayPoint.setVisible(false);
