...
import com.wavenet.ding.qpps.utils.cameralibrary.util.AngleUtil;
import com.wavenet.ding.qpps.utils.cameralibrary.util.CameraParamUtil;
import com.wavenet.ding.qpps.utils.cameralibrary.util.CheckPermission;
...
public class CameraInterface implements Camera.PreviewCallback {
    ...
    public void setZoom(float zoom, int type) {
        ...
        switch (type) {
            ...
            case TYPE_CAPTURE:
                ...
                LogUtils.i("doStartPreview", "setZoom = " + nowScaleRate);
                break;
        }
    ...
    public synchronized void switchCamera(SurfaceHolder holder, float screenProp) {
        ...
        doDestroyCamera();
        LogUtils.i("doStartPreview", "open start");
        openCamera(SELECTED_CAMERA);
//        mCamera = Camera.open();
        if (Build.VERSION.SDK_INT > 17 && this.mCamera != null) {
            try {
    ...
    public void doStartPreview(SurfaceHolder holder, float screenProp) {
        if (isPreviewing) {
            LogUtils.i("doStartPreview", "doStartPreview isPreviewing");
        }
