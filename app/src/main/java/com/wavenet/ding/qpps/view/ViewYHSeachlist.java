...
public class ViewYHSeachlist extends LinearLayout implements View.OnClickListener, AdapterView.OnItemClickListener, PullToRefreshRecyclerView.OnRefreshAndLoadMoreListener {
    ...
    public ViewYHSeachlist(Context context) {
        super(context);
        initView(context);
    }

    public ViewYHSeachlist(Context context, AttributeSet attrs) {
        super(context, attrs);
        initView(context);
    }

    public ViewYHSeachlist(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void initView(Context context) {
        mContext = context;
        mActivity = (MainMapYHActivity) context;
    ...
    public void setdata() {
        ...
        mTradapter.setOnItemClickListener(new FourthSeachRecyclerViewAdapter.OnItemClickListener() {
            ...
            public void onItemClick(View view, int position) {
                mActivity.mAAtt.initB().onClickgraphicsOverlayPoint.getGraphics().clear();
                mActivity.mAAtt.initB().onClickgraphicsOverlayLine.getGraphics().clear();
                ...
                if (mCheckId == 1 || mCheckId == 3) {//下标是1、3代表管道，其他都是Point// line graphic
                    mActivity.mAAtt.initB().onClickgraphicsOverlayLine.setRenderer(lineRenderer);
                    ...
                    mActivity.mAAtt.initB().onClickgraphicsOverlayLine.getGraphics().add(mGraphic);
                    mActivity.mAAtt.initB().onClickgraphicsOverlayLine.setVisible(true);
                    mActivity.mapv.setViewpointGeometryAsync(lineGeometry.getExtent(), 100);
                } else {
                    mActivity.mAAtt.initB().onClickgraphicsOverlayPoint.setRenderer(pointRenderer);
                    ...
                    mActivity.mAAtt.initB().onClickgraphicsOverlayPoint.getGraphics().add(mGraphic);
                    mActivity.mAAtt.initB().onClickgraphicsOverlayPoint.setVisible(true);
                    mActivity.mapv.setViewpointCenterAsync(pointGeometry, 500);
                }
