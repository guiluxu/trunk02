package com.wavenet.ding.qpps.utils.cameralibrary;
...
import com.wavenet.ding.qpps.utils.cameralibrary.listener.CaptureListener;
...
import com.wavenet.ding.qpps.utils.cameralibrary.listener.TypeListener;
import com.wavenet.ding.qpps.utils.cameralibrary.state.CameraMachine;
import com.wavenet.ding.qpps.utils.cameralibrary.util.FileUtil;
import com.wavenet.ding.qpps.utils.cameralibrary.util.ScreenUtils;
import com.wavenet.ding.qpps.utils.cameralibrary.view.CameraView;
...
//    private static final String TAG = "JCameraView";
    ...
    private void initData() {
        ...
        LogUtils.i("zoom = ", zoomGradient);
        machine = new CameraMachine(getContext(), this, this);
    }

    private void initView() {
        setWillNotDraw(false);
        View view = LayoutInflater.from(mContext).inflate(R.layout.activity_camera_view, this);
        ...
        mCaptureLayout.setCaptureLisenter(new CaptureListener() {
            ...
            public void recordZoom(float zoom) {
                LogUtils.i("recordZoom", "recordZoom");
...
//        });
    ...
    public void onResume() {
        LogUtils.i("JCameraView onResume", "JCameraView onResume");
    ...
    //生命周期onPause
    public void onPause() {
        LogUtils.i("JCameraView onPause", "JCameraView onPause");
        stopVideo();
    ...
    public void surfaceCreated(SurfaceHolder holder) {
        LogUtils.i("JCameraView SurfaceCreated", "JCameraView SurfaceCreated");
        new Thread() {
            @Override
            public void run() {
    ...
    public void surfaceDestroyed(SurfaceHolder holder) {
        LogUtils.i("JCameraView SurfaceDestroyed", "JCameraView SurfaceDestroyed");
...
//                    Log.i("CJT", "result = " + (result - firstTouchLength));
    ...
    public void startPreviewCallback() {
        LogUtils.i("startPreviewCallback", "startPreviewCallback");
