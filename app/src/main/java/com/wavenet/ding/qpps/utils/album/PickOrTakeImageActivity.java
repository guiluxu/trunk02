package com.wavenet.ding.qpps.utils.album;
...
import com.wavenet.ding.qpps.activity.TakePhotoActivity;
...
//    private TranslateAnimation reverseanimation;
    ...
    protected void initView() {
        ...
        tv_choose_image_directory = findViewById(R.id.tv_choose_image_directory);
...
//        listView = new ListView(this);
        ...
        rl_choose_directory = findViewById(R.id.rl_choose_directory);
        listView = findViewById(R.id.lv_directories);
...
//        window.setBackgroundDrawable(getResources().getDrawable(R.color.white));
        ...
        btn_choose_finish = findViewById(R.id.btn_choose_finish);
    ...
    private void takePic() {
        Intent intent = new Intent(PickOrTakeImageActivity.this, TakePhotoActivity.class);
    ...
    private class GridViewAdapter extends BaseAdapter {
        ...
        public View getView(int i, View view, ViewGroup viewGroup) {
            ...
            if (view == null || view.getTag() == null) {
                ...
                holder.iv_content = view.findViewById(R.id.iv_content);
                holder.v_gray_masking = view.findViewById(R.id.v_gray_masking);
                holder.iv_pick_or_not = view.findViewById(R.id.iv_pick_or_not);
                if (picNums == 1) {
            ...
            if (bitmap != null) {
                ...
                holder.iv_content.setBackgroundResource(R.mipmap.ic_launcher);
            }
            return view;
        }
    }
    ...
    private class ListviewAdapter extends BaseAdapter {
        ...
        public View getView(int i, View view, ViewGroup viewGroup) {
            if (view == null || view.getTag() == null) {
                ...
                holder.iv_directory_pic = view.findViewById(R.id.iv_directory_pic);
                holder.tv_directory_name = view.findViewById(R.id.tv_directory_name);
                holder.iv_directory_check = view.findViewById(R.id.iv_directory_check);
                holder.tv_directory_nums = view.findViewById(R.id.tv_directory_nums);
                view.setTag(holder);
            }
            ...
            if (bitmap != null) {
                ...
                holder.iv_directory_pic.setBackgroundResource(R.mipmap.ic_launcher);
            }
            return view;
        }
    }
