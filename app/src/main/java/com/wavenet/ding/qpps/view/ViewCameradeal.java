...
public class ViewCameradeal extends LinearLayout implements View.OnClickListener, ActionSheet.OnActionSheetSelected,GoBackInteDef.GoBack {
    private static final String TAG = TakePhotoActivity.class.getName();
    Context mContext;
    XJDealActivity mActivity;
...
RelativeLayout mRlvideo,mRlsound;
    ...
    public ViewCameradeal(Context context) {
        super(context);
        initView(context);
    }

    public ViewCameradeal(Context context, AttributeSet attrs) {
        super(context, attrs);
        initView(context);
    }


    public ViewCameradeal(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void initView(Context context) {
        mContext = context;
        mActivity = (XJDealActivity) mContext;
                        ...
                        public void sListener(String soundurl,long time) {
                          timel=time;
                            if (mRlsound.getVisibility()==GONE){
                                ...
                                MapUtil.getInstance(mContext).showIsReplaceFileDialog(mContext, ViewCameradeal.this,GoBackInteDef.setBack(GoBackInteDef.REPLACEVIDEO),"只能上传一个语音文件，是否要替换已有的语音?");
                            }
...
//                        Log.e(LOG_TAG, "exception", e);
            ...
            case R.id.iv_photo:
                ...
                ActionSheet.showSheet(mContext, ViewCameradeal.this, null);
                break;
        }
