...
public class ZoomImageView extends android.support.v7.widget.AppCompatImageView {
    ...
    public void setSourceImageBitmap(Bitmap bitmap, Activity activity) {
        sourceBitmap = bitmap;
        int screenWidth = ((WindowManager) (QPSWApplication.getInstance().getSystemService(Context.WINDOW_SERVICE))).getDefaultDisplay().getWidth();
        int screenHeight = ((WindowManager) (QPSWApplication.getInstance().getSystemService(Context.WINDOW_SERVICE))).getDefaultDisplay().getHeight();
